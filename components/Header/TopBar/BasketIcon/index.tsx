  ...
  return (
    <div
      ...
      className={`${relocated && `${basketIconStyles.relocated}`} 
          ${
            relocated &&
            dropdownMenusState.basketModal &&
    ...
    >
      ...
      <AnimatePresenceComponent
        presence={dropdownMenusState.basketModal && !relocated}
      >
        <i id={basketIconStyles.dropdownArrow} />
      </AnimatePresenceComponent>

      <DropdownMenu presence={dropdownMenusState.basketModal && !relocated}>
        Basket Content
      </DropdownMenu>
    </div>
  );
