  ...
  return (
    ...
    >
      <div id={sprinterStyles.carouselContainer}>
        ...
        <Link href="/SYGG-1500%201500W%20Pure%20Sine%20Wave%20Inverter?productId=Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0LzY4NzczMDUwNzc5MTE=">
          <motion.div
            className={sprinterStyles.imageContainer}
            style={{
              width: "8%",
        ...
        <Link href="/Pro%20Batt%20Ultra%20Battery%20to%20Battery%20Charger?productId=Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0LzY5NTQ3MTkyMTU3Njc=">
          <motion.div
            className={sprinterStyles.imageContainer}
            style={{
              width: "4.3%",
